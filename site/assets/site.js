/* Каркас страниц «Высшая математика»: шапка, навигация, подвал, маркеры SVG. */
'use strict';
(function () {
  ...
  header.innerHTML = `<div class="wrap">
    <a class="logo" href="${root}">${logoSvg}<span>Высшая математика</span></a>
  ...
  footer.innerHTML = `<div class="wrap">
    <div>Учебный сайт по курсу «Высшая математика» · кафедра математики СПбГМТУ · теория, разборы типовых расчётов и живые построения</div>
  </div>`;
